...
import { allowedGlobalSlugs, authorizeSerenaRequest, isAllowedGlobalSlug } from '@/utilities/serena'
...
export async function POST(request: NextRequest) {
  ...
  payload.logger.info(`[serena] global updated slug=${body.global} ip=${auth.clientIp || 'unknown'}`)
